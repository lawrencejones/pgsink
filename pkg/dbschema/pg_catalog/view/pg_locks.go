...
// creates new PgLocksTable with assigned alias
...
func newPgLocksTable() *PgLocksTable {
	...
	return &PgLocksTable{
		Table: postgres.NewTable("pg_catalog", "pg_locks", LocktypeColumn, DatabaseColumn, RelationColumn, PageColumn, TupleColumn, VirtualxidColumn, TransactionidColumn, ClassidColumn, ObjidColumn, ObjsubidColumn, VirtualtransactionColumn, PidColumn, ModeColumn, GrantedColumn, FastpathColumn),
