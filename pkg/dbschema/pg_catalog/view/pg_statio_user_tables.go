...
// creates new PgStatioUserTablesTable with assigned alias
...
func newPgStatioUserTablesTable() *PgStatioUserTablesTable {
	...
	return &PgStatioUserTablesTable{
		Table: postgres.NewTable("pg_catalog", "pg_statio_user_tables", RelidColumn, SchemanameColumn, RelnameColumn, HeapBlksReadColumn, HeapBlksHitColumn, IdxBlksReadColumn, IdxBlksHitColumn, ToastBlksReadColumn, ToastBlksHitColumn, TidxBlksReadColumn, TidxBlksHitColumn),
