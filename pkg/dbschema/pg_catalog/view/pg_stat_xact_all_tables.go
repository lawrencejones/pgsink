...
// creates new PgStatXactAllTablesTable with assigned alias
...
func newPgStatXactAllTablesTable() *PgStatXactAllTablesTable {
	...
	return &PgStatXactAllTablesTable{
		Table: postgres.NewTable("pg_catalog", "pg_stat_xact_all_tables", RelidColumn, SchemanameColumn, RelnameColumn, SeqScanColumn, SeqTupReadColumn, IdxScanColumn, IdxTupFetchColumn, NTupInsColumn, NTupUpdColumn, NTupDelColumn, NTupHotUpdColumn),
