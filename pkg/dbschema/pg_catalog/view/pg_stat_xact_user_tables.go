...
// creates new PgStatXactUserTablesTable with assigned alias
...
func newPgStatXactUserTablesTable() *PgStatXactUserTablesTable {
	...
	return &PgStatXactUserTablesTable{
		Table: postgres.NewTable("pg_catalog", "pg_stat_xact_user_tables", RelidColumn, SchemanameColumn, RelnameColumn, SeqScanColumn, SeqTupReadColumn, IdxScanColumn, IdxTupFetchColumn, NTupInsColumn, NTupUpdColumn, NTupDelColumn, NTupHotUpdColumn),
