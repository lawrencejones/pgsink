...
type PgStatDatabaseTable struct {
	...
	EXCLUDED pgStatDatabaseTable
}

// AS creates new PgStatDatabaseTable with assigned alias
...
func newPgStatDatabaseTable() *PgStatDatabaseTable {
	return &PgStatDatabaseTable{
		pgStatDatabaseTable: newPgStatDatabaseTableImpl("pg_catalog", "pg_stat_database"),
		EXCLUDED:            newPgStatDatabaseTableImpl("", "excluded"),
	}
}

func newPgStatDatabaseTableImpl(schemaName, tableName string) pgStatDatabaseTable {
	var (
