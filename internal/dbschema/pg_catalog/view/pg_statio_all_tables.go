...
type PgStatioAllTablesTable struct {
	pgStatioAllTablesTable

	EXCLUDED pgStatioAllTablesTable
}

// AS creates new PgStatioAllTablesTable with assigned alias
...
func newPgStatioAllTablesTable() *PgStatioAllTablesTable {
	return &PgStatioAllTablesTable{
		pgStatioAllTablesTable: newPgStatioAllTablesTableImpl("pg_catalog", "pg_statio_all_tables"),
		EXCLUDED:               newPgStatioAllTablesTableImpl("", "excluded"),
	}
}

func newPgStatioAllTablesTableImpl(schemaName, tableName string) pgStatioAllTablesTable {
	var (
