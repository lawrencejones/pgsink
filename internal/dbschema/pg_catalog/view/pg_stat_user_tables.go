...
var PgStatUserTables = newPgStatUserTablesTable()

type pgStatUserTablesTable struct {
	postgres.Table
...
type PgStatUserTablesTable struct {
	pgStatUserTablesTable

	EXCLUDED pgStatUserTablesTable
}

// AS creates new PgStatUserTablesTable with assigned alias
func (a *PgStatUserTablesTable) AS(alias string) *PgStatUserTablesTable {
	aliasTable := newPgStatUserTablesTable()
	aliasTable.Table.AS(alias)
	return aliasTable
}

func newPgStatUserTablesTable() *PgStatUserTablesTable {
	return &PgStatUserTablesTable{
		pgStatUserTablesTable: newPgStatUserTablesTableImpl("pg_catalog", "pg_stat_user_tables"),
		EXCLUDED:              newPgStatUserTablesTableImpl("", "excluded"),
	}
}

func newPgStatUserTablesTableImpl(schemaName, tableName string) pgStatUserTablesTable {
	var (
