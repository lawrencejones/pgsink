...
// creates new PgStatioSysIndexesTable with assigned alias
...
func newPgStatioSysIndexesTable() *PgStatioSysIndexesTable {
	...
	return &PgStatioSysIndexesTable{
		Table: postgres.NewTable("pg_catalog", "pg_statio_sys_indexes", RelidColumn, IndexrelidColumn, SchemanameColumn, RelnameColumn, IndexrelnameColumn, IdxBlksReadColumn, IdxBlksHitColumn),
