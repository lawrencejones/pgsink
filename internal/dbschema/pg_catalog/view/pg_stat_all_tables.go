...
var PgStatAllTables = newPgStatAllTablesTable()

type pgStatAllTablesTable struct {
	postgres.Table
...
type PgStatAllTablesTable struct {
	pgStatAllTablesTable

	EXCLUDED pgStatAllTablesTable
}

// AS creates new PgStatAllTablesTable with assigned alias
func (a *PgStatAllTablesTable) AS(alias string) *PgStatAllTablesTable {
	aliasTable := newPgStatAllTablesTable()
	aliasTable.Table.AS(alias)
	return aliasTable
}

func newPgStatAllTablesTable() *PgStatAllTablesTable {
	return &PgStatAllTablesTable{
		pgStatAllTablesTable: newPgStatAllTablesTableImpl("pg_catalog", "pg_stat_all_tables"),
		EXCLUDED:             newPgStatAllTablesTableImpl("", "excluded"),
	}
}

func newPgStatAllTablesTableImpl(schemaName, tableName string) pgStatAllTablesTable {
	var (
