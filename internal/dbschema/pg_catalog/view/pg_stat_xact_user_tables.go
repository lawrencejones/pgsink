...
var PgStatXactUserTables = newPgStatXactUserTablesTable()

type pgStatXactUserTablesTable struct {
	postgres.Table
...
type PgStatXactUserTablesTable struct {
	pgStatXactUserTablesTable

	EXCLUDED pgStatXactUserTablesTable
}

// AS creates new PgStatXactUserTablesTable with assigned alias
func (a *PgStatXactUserTablesTable) AS(alias string) *PgStatXactUserTablesTable {
	aliasTable := newPgStatXactUserTablesTable()
	aliasTable.Table.AS(alias)
	return aliasTable
}

func newPgStatXactUserTablesTable() *PgStatXactUserTablesTable {
	return &PgStatXactUserTablesTable{
		pgStatXactUserTablesTable: newPgStatXactUserTablesTableImpl("pg_catalog", "pg_stat_xact_user_tables"),
		EXCLUDED:                  newPgStatXactUserTablesTableImpl("", "excluded"),
	}
}

func newPgStatXactUserTablesTableImpl(schemaName, tableName string) pgStatXactUserTablesTable {
	var (
