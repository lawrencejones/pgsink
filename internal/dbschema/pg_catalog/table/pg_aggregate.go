...
func newPgAggregateTable() *PgAggregateTable {
	return &PgAggregateTable{
		pgAggregateTable: newPgAggregateTableImpl("pg_catalog", "pg_aggregate"),
		EXCLUDED:         newPgAggregateTableImpl("", "excluded"),
	}
}

func newPgAggregateTableImpl(schemaName, tableName string) pgAggregateTable {
	var (
