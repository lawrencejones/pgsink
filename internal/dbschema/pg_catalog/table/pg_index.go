...
func newPgIndexTable() *PgIndexTable {
	return &PgIndexTable{
		pgIndexTable: newPgIndexTableImpl("pg_catalog", "pg_index"),
		EXCLUDED:     newPgIndexTableImpl("", "excluded"),
	}
}

func newPgIndexTableImpl(schemaName, tableName string) pgIndexTable {
	var (
