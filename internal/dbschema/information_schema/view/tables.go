...
func newTablesTable() *TablesTable {
	...
	return &TablesTable{
		Table: postgres.NewTable("information_schema", "tables", TableCatalogColumn, TableSchemaColumn, TableNameColumn, TableTypeColumn, SelfReferencingColumnNameColumn, ReferenceGenerationColumn, UserDefinedTypeCatalogColumn, UserDefinedTypeSchemaColumn, UserDefinedTypeNameColumn, IsInsertableIntoColumn, IsTypedColumn, CommitActionColumn),
